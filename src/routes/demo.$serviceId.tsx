    ...
    <div className="p-6 bg-white border-[3px] border-[#1c293c] shadow-[6px_6px_0px_0px_#1c293c] rounded-xl flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
        ...
        <div className="lg:col-span-4 flex flex-col gap-4 bg-[#f4f0e6] p-4 rounded-xl border-[3px] border-[#1c293c] shadow-[3px_3px_0px_0px_#1c293c]">
          <div>
            <label className="text-xs font-mono font-black uppercase text-[#1c293c]">System Persona Prompt</label>
            <textarea
              value={systemPrompt}
          ...
          <div>
            <span className="text-xs font-mono font-black uppercase text-[#1c293c] block mb-2">Preset Prompts</span>
            <div className="flex flex-col gap-2">
              <button
                type="button"
                onClick={() => handleSend("Report: Water main gushing outside Marine Drive Sector 4")}
        ...
        <div className="lg:col-span-8 flex flex-col h-[480px] bg-white rounded-xl border-[3px] border-[#1c293c] shadow-[4px_4px_0px_0px_#1c293c] overflow-hidden">
          <div className="p-3 bg-[#1c293c] text-white flex items-center justify-between">
            <span className="text-xs font-mono font-extrabold uppercase">Interactive Chat Terminal</span>
            <button
              type="button"
  ...
  return (
    <main className="mx-auto w-full max-w-6xl px-6 pb-16 pt-10">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          <Link to="/" className="text-sm font-extrabold text-[#1c293c] hover:underline bg-[#fdc800] border-[2px] border-[#1c293c] px-3 py-1 rounded shadow-[2px_2px_0px_0px_#1c293c] inline-block">
          ...
          <h1 className="mt-2 font-display text-3xl font-black text-[#1c293c] md:text-4xl">{service.name}</h1>
      ...
      <section className="mt-10">
        <h2 className="eyebrow">
          Example Telemetry Payload & Outputs
        </h2>
        <div className="mt-4 grid gap-4 md:grid-cols-2">
          {service.examples.map((ex) => (
            <div key={ex.label} className="rounded-xl border-[3px] border-[#1c293c] bg-white p-4 shadow-[4px_4px_0px_0px_#1c293c]">
              ...
              <p className="mt-1 whitespace-pre-line text-xs font-bold text-[#1c293c] bg-[#f4f0e6] p-2.5 rounded border border-[#1c293c]">{ex.input}</p>
